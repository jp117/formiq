...
export default function CreateItemModal({ 
  ...
  const getTitle = () => {
    switch (type) {
      case 'switchboards': return 'Create New Switchboard'
      case 'integration': return 'Create New Integration'
      case 'misc': return 'Create New Misc Item'
    }
  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-500"
                  placeholder="e.g., PLC Integration"
                />
              </div>
            </div>
          )}
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-500"
                  placeholder="Describe the misc item..."
                />
              </div>
            </>
          )}
